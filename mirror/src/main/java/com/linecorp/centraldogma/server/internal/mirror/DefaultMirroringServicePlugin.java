...
public final class DefaultMirroringServicePlugin implements MirroringServicePlugin {

    @Nullable
    private volatile MirroringService mirroringService;
    ...
    public synchronized CompletionStage<Void> start(PluginContext context) {
        ...
        MirroringService mirroringService = this.mirroringService;
