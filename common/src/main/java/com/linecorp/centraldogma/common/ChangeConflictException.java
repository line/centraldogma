...
/**
 * A {@link CentralDogmaException} that is raised when attempted to push a commit which cannot be applied
 * without a conflict.
 */
public class ChangeConflictException extends CentralDogmaException {

    private static final long serialVersionUID = 1626692577056934706L;
