 ...
 * on the xDS group identified by the {@code {group}} path variable.
 */
@DecoratorFactory(RequiresXdsGroupRoleDecoratorFactory.class)
@Retention(RetentionPolicy.RUNTIME)
@Target({ ElementType.TYPE, ElementType.METHOD })
public @interface RequiresXdsGroupRole {

    /**
     * The required {@link RepositoryRole}. Defaults to {@link RepositoryRole#WRITE}.
     */
