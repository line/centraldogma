---
title: Known issues
description: Security considerations and previously disclosed vulnerabilities.
---
...
- Privilege Escalation was found in Central Dogma.
  ...
  - Please check [CVE-2021-38388](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-38388) to get more information.
...
- DOM based, Cross-site Scripting (XSS) was found in Central Dogma.
  ...
  - Please check [CVE-2019-6002](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-6002) to get more information.

- If you found security bugs, please let us know [dl_oss_dev@linecorp.com](mailto:dl_oss_dev@linecorp.com) or
  send [Discord DM](https://armeria.dev/s/discord) to maintainer.
