...
- `Disable TLS verification` (`kubeconfig.trustCerts`)

  - skips TLS certificate verification. Use this only in a controlled environment with a self-signed control plane.
