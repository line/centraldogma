...
- `factoryClassName` (string)
  ...
  - the fully-qualified class name of the `AuthProviderFactory` implementation.
    Can be one of
...
For remote access to an authenticated server, configure TLS and open
`https://{your-central-dogma-domain-or-ip}:36462` in your web browser.
