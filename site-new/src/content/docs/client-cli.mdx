...
description: Create projects, browse and modify files, and watch for changes with the dogma command-line client.
---
...
We will learn more about adding and editing files in a repository later in the section
[Modifying a repository](#modifying-a-repository).
