...
// TODO(minwoox): Make TestDnsServer in Armeria as an extension and export it.
final class TestDnsServer implements AutoCloseable {
    ...
    DnsServerAddressStreamProvider dnsServerList() {
        final InetSocketAddress dnsServerAddr = (InetSocketAddress) channel.localAddress();
