...
import com.linecorp.centraldogma.server.admin_v2.authentication.Role;
import com.linecorp.centraldogma.server.admin_v2.dto.ChangeDto;
import com.linecorp.centraldogma.server.admin_v2.dto.CommitDto;
import com.linecorp.centraldogma.server.admin_v2.dto.CommitMessageDto;
import com.linecorp.centraldogma.server.admin_v2.dto.EntryDto;
import com.linecorp.centraldogma.server.admin_v2.dto.EntryWithRevisionDto;
import com.linecorp.centraldogma.server.admin_v2.dto.RepositoryDto;
import com.linecorp.centraldogma.server.admin_v2.dto.RevisionDto;
import com.linecorp.centraldogma.server.admin_v2.exception.BadRequestException;
...
public class RepositoryService extends AbstractService {
    ...
    public CompletionStage<Object> addOrEditFile(@Param("projectName") String projectName,
        ...
        return push(projectName, repositoryName, new Revision(revision), Role.defaultAuthor(),
    ...
    public DefaultHttpResponse deleteFile(@Param("projectName") String projectName,
        ...
        push(projectName, repositoryName, new Revision(revision), Role.defaultAuthor(),
             commitMessage.getSummary(), commitMessage.getDetail().getContent(),
    ...
    private CompletableFuture<?> push0(String projectName, String repositoryName,
                                       ...
                                       String commitSummary, String commitDetail, Markup commitMarkup,
                                       Change<?> change) {
        return normalizeChanges(projectManager(), projectName, repositoryName, normalizedRev, ImmutableList.of(change))
                .thenCompose(changes -> execute(Command.push(projectName, repositoryName, normalizedRev, author,
