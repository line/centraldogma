    ...
    static Mirror of(@Nullable String id, Cron schedule, MirrorDirection direction,
        ...
        switch (scheme) {
            case SCHEME_DOGMA: {
                ...
                return new CentralDogmaMirror(id, schedule, direction, credential, localRepo, localPath,
            ...
            case SCHEME_GIT_FILE: {
                ...
                return new GitMirror(id, schedule, direction, credential, localRepo, localPath,
