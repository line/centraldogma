...
public final class ZooKeeperReplicationConfig implements ReplicationConfig {
    ...
    static final int DEFAULT_NUM_WORKERS = 16;
    static final int DEFAULT_MAX_LOG_COUNT = 100;
    static final long DEFAULT_MIN_LOG_AGE_MILLIS = TimeUnit.HOURS.toMillis(1);
