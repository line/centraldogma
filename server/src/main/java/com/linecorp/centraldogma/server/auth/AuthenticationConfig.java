...
public final class AuthenticationConfig {
    ...
    private final AuthenticationProviderFactory factory;
     ...
     *
     * @param factoryClassName the fully-qualified class name of the {@link AuthenticationProviderFactory}
     ...
     *                         the cache for {@link AuthenticatedSession} of the server
     * @param sessionTimeoutMillis the timeout for {@link AuthenticatedSession}s of the server
    ...
    public AuthenticationConfig(
        ...
        this((AuthenticationProviderFactory) AuthenticationConfig.class
                     .getClassLoader()
     ...
     * Creates a new instance.
     *
     * @param factory the {@link AuthenticationProviderFactory} instance
     * @param administrators the login names of the administrators
     * @param caseSensitiveLoginNames the flag whether case-sensitive matching is performed when login names
     *                                are compared
     * @param sessionCacheSpec the cache specification which determines the capacity and behavior of
     ...
     * @param properties the additional properties which are used in the factory
     */
    public AuthenticationConfig(AuthenticationProviderFactory factory,
    ...
    public AuthenticationProviderFactory factory() {
        return factory;
    }
     ...
     * {@link AuthenticationConfig#caseSensitiveLoginNames()} property.
     */
