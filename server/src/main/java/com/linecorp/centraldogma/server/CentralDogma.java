...
import com.linecorp.centraldogma.server.internal.admin.decorator.RoleResolvingDecorator;
...
public class CentralDogma {
    ...
    private Server startServer(ProjectManager pm, CommandExecutor executor,
        ...
        sb.service("/docs", new AbstractHttpService() {
            ...
            protected HttpResponse doGet(ServiceRequestContext ctx, HttpRequest req)
                    throws Exception {
                return HttpResponse.of(AggregatedHttpMessage.of(
    ...
    private void configureHttpApi(ServerBuilder sb,
        ...
        final Function<Service<HttpRequest, HttpResponse>,
                ? extends Service<HttpRequest, HttpResponse>> v1Decorator;
        if (cfg.isSecurityEnabled()) {
            ...
            v1Decorator = RoleResolvingDecorator.newDecorator(mds).andThen(decorator);
        } else {
            decorator = HttpAuthService.newDecorator(new CsrfTokenAuthorizer());
            v1Decorator = decorator;
        }
        ...
        sb.annotatedService(API_V1_PATH_PREFIX,
                            new ProjectServiceV1(safePm, executor, mds), v1Decorator,
                            v1RequestConverter, v1ResponseConverter);
        sb.annotatedService(API_V1_PATH_PREFIX,
                            new RepositoryServiceV1(safePm, executor, mds), v1Decorator,
                            v1RequestConverter, v1ResponseConverter);
        sb.annotatedService(API_V1_PATH_PREFIX,
                            new ContentServiceV1(safePm, executor, watchService), v1Decorator,
                            v1RequestConverter, v1ResponseConverter);
        sb.annotatedService(API_V1_PATH_PREFIX,
                            new CommitServiceV1(safePm, executor), v1Decorator,
                            v1RequestConverter, v1ResponseConverter);
