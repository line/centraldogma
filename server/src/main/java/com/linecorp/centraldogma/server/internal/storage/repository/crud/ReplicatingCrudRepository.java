 ...
 */
public final class ReplicatingCrudRepository<T> implements CrudRepository<T> {

    private final CrudOperation<T> crudOperation;
    private final CrudContext ctx;

    public ReplicatingCrudRepository(Class<T> entityType, CommandExecutor executor,
                                     ProjectManager projectManager,
                                     String projectName, String repoName, String targetPath) {
        crudOperation = new ReplicatingCrudOperation<>(entityType, executor, projectManager);
