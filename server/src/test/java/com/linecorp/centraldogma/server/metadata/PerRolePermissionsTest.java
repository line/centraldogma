...
class PerRolePermissionsTest {
    ...
    void deserialize() throws Exception {
        ...
        assertThat(oldFormatPermission.member()).isSameAs(Permission.WRITE);
        assertThat(oldFormatPermission.guest()).isSameAs(Permission.READ);
        ...
        assertThat(newFormatPermission.member()).isSameAs(Permission.WRITE);
        assertThat(newFormatPermission.guest()).isSameAs(Permission.READ);
        ...
        assertThat(newFormatPermission2.member()).isNull();
        assertThat(newFormatPermission2.guest()).isNull();
        ...
        assertThat(mixedFormatPermission.member()).isSameAs(Permission.WRITE);
        assertThat(mixedFormatPermission.guest()).isSameAs(Permission.READ);
    }
}
